...
function Modal4() {
    ...
    const uploadPost = async () => {
        ...
        const docRef = await addDoc(collection(db, 'posts4'), {
        ...
        //3)
        const imageRef = ref(storage, `posts4/${docRef.id}/image`);
        ...
        await uploadString(imageRef, selectedFile, "data_url").then(
            async (snapshot) => {
                ...
                //4)
                await updateDoc(doc(db, 'posts4', docRef.id), {
                    image: downloadURL
                })
            }
        );
                            ...
                            <div>
                                ...
                                <div className="flex justify-center space-x-4 mt-4">
                                    <button
                                        ...
                                        className="inline-flex justify-center w-full rounded-md border border-transparent shadow-sm px-4 py-2 bg-gray-500 text-base font-medium text-white hover:bg-purple-700 focus:outline-none focus:ring-2 
                                    focus:ring-offset-2 focus:ring-purple-500 sm:text-sm
                                    disabled:hover:cursor-not-allowed
                                    hover:disabled:bg-gray-700"
                                        onClick={uploadPost}
                                    >
